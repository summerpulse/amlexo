...
public class MyAdapter extends BaseAdapter {
	...
	public MyAdapter(Context context, List<String> it, List<String> pa) {
		...
		items = it;
		paths = pa;
		iconFolder = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.folder);
		iconAudio = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.music);
		iconVideo = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.movie);
		iconImage = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.photo);
		iconFile = BitmapFactory.decodeResource(context.getResources(),
				R.drawable.doc);
	}
