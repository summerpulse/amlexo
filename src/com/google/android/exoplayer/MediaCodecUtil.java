...
public class MediaCodecUtil
{
    ...
    private static final HashMap<String, Pair<MediaCodecInfo, CodecCapabilities>> codecs = new HashMap<String, Pair<MediaCodecInfo, CodecCapabilities>>();

    /**
     * Get information about the decoder that will be used for a given mime
     * type. If no decoder exists for the mime type then null is returned.
     *
     * @param mimeType
     *            The mime type.
     * @return Information about the decoder that will be used, or null if no
     *         decoder exists.
     */
    ...
    /**
     * Optional call to warm the codec cache. Call from any appropriate place to
     * hide latency.
     */
    ...
    /**
     * Returns the best decoder and its capabilities for the given mimeType. If
     * there's no decoder returns null.
     */
    private static synchronized Pair<MediaCodecInfo, CodecCapabilities> getMediaCodecInfo(String mimeType)
    {
        ...
        // Note: MediaCodecList is sorted by the framework such that the best
        // decoders come first.
    ...
    /**
     * @param profile
     *            An AVC profile constant from {@link CodecProfileLevel}.
     * @param level
     *            An AVC profile level from {@link CodecProfileLevel}.
     * @return Whether the specified profile is supported at the specified
     *         level.
     */
