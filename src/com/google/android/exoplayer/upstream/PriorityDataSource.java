...
/**
 * Allows {@link #open(DataSpec)} and {@link #read(byte[], int, int)} calls only
 * if the specified priority is the highest priority of any task.
 * {@link NetworkLock.PriorityTooLowException} is thrown when this condition
 * does not hold.
 */
