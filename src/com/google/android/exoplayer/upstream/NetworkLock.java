 ...
 * <p>
 * Manages different priority network tasks. A network task that wishes to have
 * its priority respected, and respect the priority of other tasks, should
 * register itself with the lock prior to making network requests. It should
 * then call one of the lock's proceed methods frequently during execution, so
 * as to ensure that it continues only if it is the highest (or equally highest)
 * priority task.
 * <p>
...
public final class NetworkLock
{
    ...
    /**
     * Thrown when a task is attempts to proceed when it does not have the
     * highest priority.
     */
    ...
    /**
     * Blocks until the passed priority is the lowest one (i.e. highest
     * priority).
     *
     * @param priority
     *            The priority of the task that would like to proceed.
     */
     ...
     *             If the passed priority is not high enough to proceed.
     */
