...
public class DefaultBandwidthMeter implements BandwidthMeter, TransferListener
{
     ...
     * {@link DefaultBandwidthMeter} events.
     */
    public interface EventListener
    {
         ...
         *
         * @param elapsedMs
         *            The time taken to transfer the bytes, in milliseconds.
         * @param bytes
         *            The number of bytes transferred.
         * @param bitrate
         *            The estimated bitrate in bits/sec, or {@link #NO_ESTIMATE}
         *            if no estimate is available. Note that this estimate is
         *            typically derived from more information than {@code bytes}
         *            and {@code elapsedMs}.
         */
    ...
    public synchronized void onTransferEnd()
    {
        ...
        if (elapsedMs > 0)
        {
            ...
            bitrateEstimate = Float.isNaN(bandwidthEstimateFloat) ? NO_ESTIMATE : (long) bandwidthEstimateFloat;
