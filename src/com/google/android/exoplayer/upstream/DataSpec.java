...
public final class DataSpec
{
    ...
    /**
     * True if the data at {@link #uri} is the full stream. False otherwise. An
     * example where this may be false is if {@link #uri} defines the location
     * of a cached part of the stream.
     */
    ...
    /**
     * The length of the data. Greater than zero, or equal to
     * {@link C#LENGTH_UNBOUNDED}.
     */
    public final long length;
    /**
     * A key that uniquely identifies the original stream. Used for cache
     * indexing. May be null if the {@link DataSpec} is not intended to be used
     * in conjunction with a cache.
     */
     ...
     * @param uri
     *            {@link #uri}.
     * @param absoluteStreamPosition
     *            {@link #absoluteStreamPosition}, equal to {@link #position}.
     * @param length
     *            {@link #length}.
     * @param key
     *            {@link #key}.
     ...
     * @param position
     *            {@link #position}.
     * @param uriIsFullStream
     *            {@link #uriIsFullStream}.
     */
    ...
    {
        return "DataSpec[" + uri + ", " + uriIsFullStream + ", " + absoluteStreamPosition + ", " + position + ", " + length + ", " + key + "]";
    }
