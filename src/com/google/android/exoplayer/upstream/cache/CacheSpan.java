...
public final class CacheSpan implements Comparable<CacheSpan>
{
    ...
    private static final Pattern cacheFilePattern = Pattern.compile("^(.+)\\.(\\d+)\\.(\\d+)(" + SUFFIX_ESCAPED + ")$");
    ...
    /**
     * The file corresponding to this {@link CacheSpan}, or null if
    ...
    /**
     * Renames the file underlying this cache span to update its last access
     * time.
     *
