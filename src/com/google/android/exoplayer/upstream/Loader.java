...
public final class Loader
{
    ...
    /**
     * Interface definition for a callback to be notified of {@link Loader}
     * events.
     */
    ...
    /**
     * @param threadName
     *            A name for the loader's thread.
     * @param listener
     *            A listener to invoke when state changes occur.
     */
     ...
     * <p>
     * A {@link Loader} instance can only load one {@link Loadable} at a time,
     * and so this method must not be called when another load is in progress.
     *
     * @param loadable
     *            The {@link Loadable} to load.
     */
     ...
     *
     * @return Whether the {@link Loader} is currently loading a
     *         {@link Loadable}.
     */
     ...
     * <p>
     * This method should be called when the {@link Loader} is no longer
     * required.
     */
    public void release()
    {
