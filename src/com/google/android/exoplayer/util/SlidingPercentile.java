...
/**
 * Calculate any percentile over a sliding window of weighted values. A maximum
 * total weight is configured. Once the maximum weight is reached, the oldest
 * value is reduced in weight until it reaches zero and is removed. This
 * maintains a constant total weight at steady state.
 * <p>
 * SlidingPercentile can be used for bandwidth estimation based on a sliding
 * window of past download rate observations. This is an alternative to sliding
 * mean and exponential averaging which suffer from susceptibility to outliers
 * and slow adaptation to step functions.
 *
 * @see <a href="http://en.wikipedia.org/wiki/Moving_average">Wiki: Moving
 *      average</a>
 * @see <a href="http://en.wikipedia.org/wiki/Selection_algorithm">Wiki:
...
public class SlidingPercentile
{
     ...
     *
     * @param percentile
     *            The desired percentile, expressed as a fraction in the range
     *            (0,1].
