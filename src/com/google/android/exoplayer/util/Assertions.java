...
public final class Assertions
{
    ...
    /**
     * Ensures the truth of an expression involving one or more arguments passed
     ...
     *            A boolean expression.
     * @param errorMessage
     *            The exception message to use if the check fails. The message
     *            is converted to a {@link String} using
     ...
     * @param errorMessage
     *            The exception message to use if the check fails. The message
     *            is converted to a string using {@link String#valueOf(Object)}.
     * @throws IllegalStateException
     *             If {@code expression} is false.
     */
    ...
    /**
     * Ensures that a string passed as an argument to the calling method is not
     * null or 0-length.
     *
     * @param string
     *            A string.
     ...
     * @throws IllegalArgumentException
     *             If {@code string} is null or 0-length.
     */
