...
/**
 * Utility class for managing a set of tags for which verbose logging should be
 * enabled.
 */
public class VerboseLogUtil
{
     ...
     *
     * @param enable
     *            True if all logging should be enabled; false if only tags
     *            enabled by setEnabledTags should have logging enabled.
     */
