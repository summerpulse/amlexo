...
public class SmoothStreamingManifest
{
    ...
    public static class StreamElement
    {
        ...
        /**
         * Builds a URL for requesting the specified chunk of the specified
         * track.
         *
         * @param track
        ...
        public String buildRequestUrl(int track, int chunkIndex)
        {
            ...
            return url.replace(URL_PLACEHOLDER_BITRATE, Integer.toString(tracks[track].bitrate)).replace(URL_PLACEHOLDER_START_TIME, Long.toString(chunkStartTimes[chunkIndex]));
        }
