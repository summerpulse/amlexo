...
public class SingleSampleMediaChunk extends MediaChunk
{
     ...
     * @param sampleFormat
     *            The format of the media contained by the chunk.
     */
     ...
     *            The format of the media contained by the chunk.
     * @param headerData
     *            Custom header data for the sample. May be null. If set, the
     *            header data is prepended to the sample data returned when
     *            {@link #read(SampleHolder)} is called. It is however not
     *            considered part of the loaded data, and so is not prepended to
     *            the data returned by {@link #getLoadedData()}. It is also not
     *            reflected in the values returned by {@link #bytesLoaded()} and
     *            {@link #getLength()}.
     */
    ...
    public boolean read(SampleHolder holder)
    {
        ...
        if (holder.allowDataBufferReplacement && (holder.data == null || holder.data.capacity() < sampleSize))
        {
