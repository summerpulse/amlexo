...
public class Format
{
     ...
     *
     * @deprecated Use {@link #bitrate}. However note that the units of
     ...
     *            The width of the video in pixels, or -1 for non-video formats.
     * @param height
     *            The height of the video in pixels, or -1 for non-video
     *            formats.
     * @param numChannels
     *            The number of audio channels, or -1 for non-audio formats.
     ...
     *            The audio sampling rate in Hz, or -1 for non-audio formats.
     * @param bitrate
     *            The average bandwidth of the format in bits per second.
     */
    public Format(String id, String mimeType, int width, int height, int numChannels, int audioSamplingRate, int bitrate)
    {
     ...
     */
    public Format(String id, String mimeType, int width, int height, int numChannels, int audioSamplingRate, int bitrate, String language)
    {
