...
/**
 * A {@link ChunkSource} providing the ability to switch between multiple other
 * {@link ChunkSource} instances.
 */
public class MultiTrackChunkSource implements ChunkSource, ExoPlayerComponent
{

    /**
     * A message to indicate a source selection. Source selection can only be
     * performed when the source is disabled.
     */
    ...
    /**
     * Gets the number of tracks that this source can switch between. May be
