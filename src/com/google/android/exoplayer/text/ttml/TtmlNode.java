...
/* package */final class TtmlNode
{
    ...
    {
        return (startTimeUs == UNDEFINED_TIME && endTimeUs == UNDEFINED_TIME) || (startTimeUs <= timeUs && endTimeUs == UNDEFINED_TIME) || (startTimeUs == UNDEFINED_TIME && timeUs < endTimeUs) || (startTimeUs <= timeUs && timeUs < endTimeUs);
    }
    ...
    private void getText(long timeUs, StringBuilder builder, boolean descendsPNode)
    {
        if (isTextNode && descendsPNode)
        {
            ...
            if (TAG_BR.equals(tag) && descendsPNode)
            {
                builder.append("\n");
            }
            else
