...
/* package */final class TrackFragment
{
    ...
    /**
     * If {@link #definesEncryptionData} is true, indicates which samples use
     * sub-sample encryption. Undefined otherwise.
     */
    public boolean[] sampleHasSubsampleEncryptionTable;
    /**
     * If {@link #definesEncryptionData} is true, indicates the length of the
     * sample encryption data. Undefined otherwise.
     */
    public int sampleEncryptionDataLength;
    /**
     * If {@link #definesEncryptionData} is true, contains binary sample
     * encryption data. Undefined otherwise.
     */
    public ParsableByteArray sampleEncryptionData;
    /**
     * Whether {@link #sampleEncryptionData} needs populating with the actual
     * encryption data.
     */
     ...
     * Resets the fragment.
     * <p>
     * The {@link #length} is set to 0, and both {@link #definesEncryptionData}
     * and {@link #sampleEncryptionDataNeedsFill} is set to false.
     */
    public void reset()
    {
        length = 0;
     ...
     * <p>
     * The {@link #length} of the fragment is set to the specified sample count,
     * and the contained tables are resized if necessary such that they are at
     * least this length.
     *
     * @param sampleCount
     *            The number of samples in the new run.
     */
    public void initTables(int sampleCount)
    {
        ...
        {
            // Size the tables 25% larger than needed, so as to make future
            // resize operations less
    ...
    /**
     * Configures the fragment to be one that defines encryption data of the
     * specified length.
     * <p>
     * {@link #definesEncryptionData} is set to true,
     * {@link #sampleEncryptionDataLength} is set to the specified length, and
     * {@link #sampleEncryptionData} is resized if necessary such that it is at
     * least this length.
     *
     * @param length
     *            The length in bytes of the encryption data.
     */
    ...
    /**
     * Fills {@link #sampleEncryptionData} for the current run from the provided
     * source.
     *
     * @param source
     *            A source from which to read the encryption data.
     * @return True if the encryption data was filled. False if the source had
     *         insufficient data.
     */
