...
/**
 * Encapsulates information parsed from a track encryption (tenc) box in an MP4
 * stream.
 */
public final class TrackEncryptionBox
{
    ...
    /**
     * @param isEncrypted
     *            Indicates the encryption state of the samples in the sample
     *            group.
     * @param initializationVectorSize
     *            The initialization vector size in bytes for the samples in the
     *            corresponding sample group.
     * @param keyId
     *            The key identifier for the samples in the corresponding sample
     *            group.
     */
