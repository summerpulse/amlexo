 ...
 * Numerical values are parsed with the assumption that their constituent bytes
...
/* package */final class ParsableByteArray
{
    ...
    /**
     * Reads an unsigned long into a long. This method is suitable for use when
     * it can be assumed that the top bit will always be set to zero.
     *
     * @throws IllegalArgumentException
     *             If the top bit of the input data is set.
     */
