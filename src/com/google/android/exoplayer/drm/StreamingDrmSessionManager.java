...
/**
 * A base class for {@link DrmSessionManager} implementations that support
 * streaming playbacks using {@link MediaDrm}.
 */
@TargetApi(18)
public class StreamingDrmSessionManager implements DrmSessionManager
{
     ...
     * {@link StreamingDrmSessionManager} events.
     */
     ...
     * @param playbackLooper
     *            The looper associated with the media playback thread. Should
     *            usually be obtained using
     *            {@link com.google.android.exoplayer.ExoPlayer#getPlaybackLooper()}
     *            .
     * @param callback
    ...
    private void postKeyRequest()
    {
        ...
        try
        {
            keyRequest = mediaDrm.getKeyRequest(sessionId, schemePsshData, mimeType, MediaDrm.KEY_TYPE_STREAMING, null);
