...
/**
 * An implementation of {@link DashSegmentIndex} that wraps a
 * {@link SegmentIndex} parsed from a media stream.
 */
public class DashWrappingSegmentIndex implements DashSegmentIndex
{
    ...
    /**
     * @param segmentIndex
     *            The {@link SegmentIndex} to wrap.
     * @param uri
     *            The {@link Uri} where the data is located.
     * @param indexAnchor
     *            The index anchor point. This value is added to the byte
     *            offsets specified in the wrapped {@link SegmentIndex}.
     */
    ...
    {
        return new RangedUri(uri, null, indexAnchor + segmentIndex.offsets[segmentNum], segmentIndex.sizes[segmentNum]);
    }
