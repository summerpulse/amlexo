...
/**
 * A concrete implementation of {@link ManifestFetcher} for loading DASH
 * manifests.
 * <p>
...
public final class MediaPresentationDescriptionFetcher extends ManifestFetcher<MediaPresentationDescription>
{
     ...
     */
    public MediaPresentationDescriptionFetcher(ManifestCallback<MediaPresentationDescription> callback)
    {
        super(callback);
     ...
     *            the data.
     */
    public MediaPresentationDescriptionFetcher(ManifestCallback<MediaPresentationDescription> callback, int timeoutMillis)
    {
    ...
    @Override
    protected MediaPresentationDescription parse(InputStream stream, String inputEncoding, String contentId, Uri baseUrl) throws IOException, ParserException
    {
        try
        {
