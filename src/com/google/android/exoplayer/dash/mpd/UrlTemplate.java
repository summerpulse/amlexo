 ...
 * <p>
 * URLs are built according to the substitution rules defined in ISO/IEC
 * 23009-1:2014 5.3.9.4.4.
 */
public final class UrlTemplate
{
    ...
    {
        // These arrays are sizes assuming each of the four possible identifiers
        // will be present at
    ...
    /**
     * Internal constructor. Use {@link #compile(String)} to build instances of
     * this class.
     */
    ...
    /**
     * Constructs a Uri from the template, substituting in the provided
     * arguments.
     * <p>
    ...
    /**
     * Parses {@code template}, placing the decomposed components into the
     * provided arrays.
     * <p>
     * If the return value is N, {@code urlPieces} will contain (N+1) strings
     ...
     * {@code identifiers} and {@code identifierFormatTags} respectively.
     *
     * @param template
     ...
     * @param identifiers
     *            A holder for identifiers parsed from the template.
     * @param identifierFormatTags
     *            A holder for format tags corresponding to the parsed
     *            identifiers.
