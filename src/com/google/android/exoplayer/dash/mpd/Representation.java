...
public abstract class Representation
{
    ...
    /**
     * Identifies the piece of content to which this {@link Representation}
     * belongs.
     * <p>
     * For example, all {@link Representation}s belonging to a video should have
     * the same {@link #contentId}, which should uniquely identify that video.
     */
     ...
     * <p>
     * If the media for a given ({@link #contentId} can change over time without
     * a change to the {@link #format}'s {@link Format#id} (e.g. as a result of
     * re-encoding the media with an updated encoder), then this identifier must
     * uniquely identify the revision of the media. The timestamp at which the
     * media was encoded is often a suitable.
     */
     ...
     *
     * @param periodStartMs
     *            The start time of the enclosing period in milliseconds.
     * @param periodDurationMs
     *            The duration of the enclosing period in milliseconds, or -1 if
     *            the duration is unknown.
     * @param contentId
     *            Identifies the piece of content to which this representation
     *            belongs.
     * @param revisionId
     *            Identifies the revision of the content.
     * @param format
    ...
    public static Representation newInstance(long periodStartMs, long periodDurationMs, String contentId, long revisionId, Format format, SegmentBase segmentBase)
    {
        if (segmentBase instanceof SingleSegmentBase)
        {
            ...
            if (segmentBase instanceof MultiSegmentBase)
            {
    ...
    /**
     * Gets a {@link RangedUri} defining the location of the representation's
    ...
    /**
     * Gets a {@link RangedUri} defining the location of the representation's
     * segment index. Null if the representation provides an index directly.
     *
    ...
    public static class SingleSegmentRepresentation extends Representation
    {
         ...
         *            The start time of the enclosing period in milliseconds.
         * @param periodDurationMs
         *            The duration of the enclosing period in milliseconds, or
         ...
         *            The content length, or -1 if unknown.
         */
        public static SingleSegmentRepresentation newInstance(long periodStartMs, long periodDurationMs, String contentId, long revisionId, Format format, Uri uri, long initializationStart, long initializationEnd, long indexStart, long indexEnd,
                long contentLength)
        {
