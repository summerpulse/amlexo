...
public abstract class SegmentBase
{
     ...
     *            A {@link RangedUri} corresponding to initialization data, if
     *            such data exists.
     * @param timescale
    ...
    /**
     * Gets the {@link RangedUri} defining the location of initialization data
     * for a given representation. May be null if no initialization data exists.
     *
     * @param representation
     *            The {@link Representation} for which initialization data is
     *            required.
     * @return A {@link RangedUri} defining the location of the initialization
     *         data, or null.
     */
    ...
    public static class SingleSegmentBase extends SegmentBase
    {
        ...
        /**
         * @param initialization
         *            A {@link RangedUri} corresponding to initialization data,
         *            if such data exists.
         * @param timescale
         *            The timescale in units per second.
         * @param presentationTimeOffset
    ...
    public abstract static class MultiSegmentBase extends SegmentBase
    {
         ...
         *            The presentation time offset. The value in seconds is the
         *            division of this value and {@code timescale}.
         * @param periodDurationMs
         *            The duration of the enclosing period in milliseconds.
         * @param startNumber
         *            The sequence number of the first segment.
         * @param duration
         *            The duration of each segment in the case of fixed duration
         *            segments. The value in seconds is the division of this
         *            value and {@code timescale}. If {@code segmentTimeline} is
         *            non-null then this parameter is ignored.
         * @param segmentTimeline
         *            A segment timeline corresponding to the segments. If null,
         *            then segments are assumed to be of fixed duration as
         *            specified by the {@code duration} parameter.
         */
        ...
        public final long getSegmentDurationUs(int sequenceNumber)
        {
            ...
            {
                return sequenceNumber == getLastSegmentNum() ? (periodDurationMs * 1000) - getSegmentTimeUs(sequenceNumber) : ((duration * 1000000L) / timescale);
            }
        }
    ...
    /**
     * A {@link MultiSegmentBase} that uses a SegmentList to define its
     * segments.
     */
    public static class SegmentList extends MultiSegmentBase
    {
         ...
         *            specified by the {@code duration} parameter.
         * @param mediaSegments
         *            A list of {@link RangedUri}s indicating the locations of
         *            the segments.
         */
    ...
    /**
     * A {@link MultiSegmentBase} that uses a SegmentTemplate to define its
     * segments.
     */
    public static class SegmentTemplate extends MultiSegmentBase
    {
         ...
         * @param initialization
         *            A {@link RangedUri} corresponding to initialization data,
         *            if such data exists. The value of this parameter is
         *            ignored if {@code initializationTemplate} is non-null.
         * @param timescale
         *            The timescale in units per second.
         * @param presentationTimeOffset
         *            The presentation time offset. The value in seconds is the
         ...
         *            then segments are assumed to be of fixed duration as
         *            specified by the {@code duration} parameter.
         * @param initializationTemplate
         *            A template defining the location of initialization data,
         *            if such data exists. If non-null then the
         *            {@code initialization} parameter is ignored. If null then
         *            {@code initialization} will be used.
         * @param mediaTemplate
         *            A template defining the location of each media segment.
         * @param baseUrl
         *            A url to use as the base for relative urls generated by
         *            the templates.
         */
        public SegmentTemplate(RangedUri initialization, long timescale, long presentationTimeOffset, long periodDurationMs, int startNumber, long duration, List<SegmentTimelineElement> segmentTimeline, UrlTemplate initializationTemplate,
        ...
        public RangedUri getInitialization(Representation representation)
        {
            ...
            {
                String urlString = initializationTemplate.buildUri(representation.format.id, 0, representation.format.bitrate, 0);
        ...
        public RangedUri getSegmentUrl(Representation representation, int sequenceNumber)
        {
            ...
            String uriString = mediaTemplate.buildUri(representation.format.id, sequenceNumber, representation.format.bitrate, time);
    ...
    public static class SegmentTimelineElement
    {
        ...
        /**
         * @param startTime
         *            The start time of the element. The value in seconds is the
         *            division of this value and the {@code timescale} of the
         *            enclosing element.
         * @param duration
         *            The duration of the element. The value in seconds is the
         *            division of this value and the {@code timescale} of the
         *            enclosing element.
         */
