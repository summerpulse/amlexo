...
public class DashWebmChunkSource implements ChunkSource
{
     ...
     *            The representations to be considered by the source.
     */
    ...
    public final void getChunkOperation(List<? extends MediaChunk> queue, long seekPositionUs, long playbackPositionUs, ChunkOperationHolder out)
    {
        ...
        if (pendingInitializationUri != null || pendingIndexUri != null)
        {
            ...
            Chunk initializationChunk = newInitializationChunk(pendingInitializationUri, pendingIndexUri, selectedRepresentation, extractor, dataSource, evaluation.trigger);
        ...
        Chunk nextMediaChunk = newMediaChunk(selectedRepresentation, segmentIndex, extractor, dataSource, nextSegmentNum, evaluation.trigger);
    ...
    private Chunk newInitializationChunk(RangedUri initializationUri, RangedUri indexUri, Representation representation, WebmExtractor extractor, DataSource dataSource, int trigger)
    {
        int expectedExtractorResult = WebmExtractor.RESULT_END_OF_STREAM;
        RangedUri requestUri;
        if (initializationUri != null)
        {
            // It's common for initialization and index data to be stored
            // adjacently. Attempt to merge
        ...
        return new InitializationWebmLoadable(dataSource, dataSpec, trigger, representation.format, extractor, expectedExtractorResult);
    }
    ...
    private class InitializationWebmLoadable extends Chunk
    {
        ...
        public InitializationWebmLoadable(DataSource dataSource, DataSpec dataSpec, int trigger, Format format, WebmExtractor extractor, int expectedExtractorResult)
        {
        ...
        protected void consumeStream(NonBlockingInputStream stream) throws IOException
        {
            ...
            {
                throw new ParserException("Invalid extractor result. Expected " + expectedExtractorResult + ", got " + result);
            }
