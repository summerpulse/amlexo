 ...
 */
/* package */class DashVodRendererBuilder implements RendererBuilder, ManifestCallback<MediaPresentationDescription>
{
    ...
    public DashVodRendererBuilder(SimplePlayerActivity playerActivity, String userAgent, String url, String contentId)
    {
    ...
    public void onManifest(String contentId, MediaPresentationDescription manifest)
    {
        ...
        ChunkSource videoChunkSource = new DashMp4ChunkSource(videoDataSource, new AdaptiveEvaluator(bandwidthMeter), videoRepresentations);
        ...
        ChunkSource audioChunkSource = new DashMp4ChunkSource(audioDataSource, new FormatEvaluator.FixedEvaluator(), audioRepresentation);
