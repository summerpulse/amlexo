...
import com.google.android.exoplayer.FFExtractor;

class VideoPlayer extends Thread
{
    // private MediaExtractor extractor = new MediaExtractor();
    public FFExtractor extractor = new FFExtractor();
    private MediaCodec decoder;
    private Surface surface;
    private static final String LOG_TAG = "MediaCodecDemo";

    public VideoPlayer(Surface surface, String url)
    {
