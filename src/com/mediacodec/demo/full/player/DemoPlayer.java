 ...
 */
public class DemoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener, DefaultBandwidthMeter.EventListener, MediaCodecVideoTrackRenderer.EventListener, MediaCodecAudioTrackRenderer.EventListener, TextTrackRenderer.TextRenderer,
        StreamingDrmSessionManager.EventListener
{
    ...
    public interface RendererBuilderCallback
    {
         ...
         *            {@link DemoPlayer} TYPE_* constants. May be null if the
         *            track names are unknown. An individual element may be null
         ...
         *            tracks, indexed by {@link DemoPlayer} TYPE_* constants.
         *            May be null if there are no types with multiple tracks. An
         *            individual element may be null if it does not have
         *            multiple tracks.
         * @param renderers
         *            Renderers indexed by {@link DemoPlayer} TYPE_* constants.
         *            An individual element may be null if there do not exist
         *            tracks of the corresponding type.
         */
    ...
    /* package */void onRenderers(String[][] trackNames, MultiTrackChunkSource[] multiTrackSources, TrackRenderer[] renderers)
    {
        ...
        for (int i = 0; i < RENDERER_COUNT; i++)
        {
            if (renderers[i] == null)
            {
                ...
                {
                    // We have a renderer so we must have at least one track,
                    // but the names are unknown.
    ...
    private void pushTrackSelection(int type, boolean allowRendererEnable)
    {
        ...
        if (trackIndex == DISABLED_TRACK)
        {
            ...
            if (multiTrackSources[type] == null)
            {
