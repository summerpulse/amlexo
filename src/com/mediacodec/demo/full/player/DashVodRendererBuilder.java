 ...
 */
public class DashVodRendererBuilder implements RendererBuilder, ManifestCallback<MediaPresentationDescription>
{
    ...
    public DashVodRendererBuilder(String userAgent, String url, String contentId, MediaDrmCallback drmCallback, TextView debugTextView)
    {
    ...
    public void onManifest(String contentId, MediaPresentationDescription manifest)
    {
        ...
        if (mimeType.equals(MimeTypes.VIDEO_MP4))
        {
            ...
            {
                // TODO: Figure out how to query supported vpX resolutions. For
                // now, restrict to standard
                // definition streams.
                videoRepresentations = getSdRepresentations(videoRepresentations);
        ...
        else
        {
            ...
            SampleSource audioSampleSource = new ChunkSampleSource(audioChunkSource, loadControl, AUDIO_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, true, mainHandler, player, DemoPlayer.TYPE_AUDIO);
