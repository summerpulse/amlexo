 ...
 */
package com.mediacodec.demo.full;

import com.google.android.exoplayer.ExoPlayer;
import com.google.android.exoplayer.VideoSurfaceView;
import com.mediacodec.demo.DemoUtil;
import com.mediacodec.demo.full.player.DashVodRendererBuilder;
import com.mediacodec.demo.full.player.DefaultRendererBuilder;
import com.mediacodec.demo.full.player.DemoPlayer;
import com.mediacodec.demo.full.player.SmoothStreamingRendererBuilder;
 ...
 */
public class FullPlayerActivity extends Activity implements SurfaceHolder.Callback, OnClickListener, DemoPlayer.Listener, DemoPlayer.TextListener
{
    ...
    private RendererBuilder getRendererBuilder()
    {
        ...
        case DemoUtil.TYPE_SS_VOD:
            return new SmoothStreamingRendererBuilder(userAgent, contentUri.toString(), contentId, new SmoothStreamingTestMediaDrmCallback(), debugTextView);
        case DemoUtil.TYPE_DASH_VOD:
            return new DashVodRendererBuilder(userAgent, contentUri.toString(), contentId, new WidevineTestMediaDrmCallback(contentId), debugTextView);
        default:
